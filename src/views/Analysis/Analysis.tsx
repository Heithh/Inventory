...
const Analysis = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        if (response.data) {
          const transformedData = transformData(response.data[0] as RawDataItem[]);
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div onClick={handleBackClick} className="absolute top-20 left-4 flex items-center hover:cursor-pointer hover:scale-125 transition duration-300 ease-in-out">
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div
          className="w-full md:w-2/3 rounded-lg sm:p-6  h-96 overflow-auto shadow-lg border border-blue-300 transition-all duration-300 ease-in-out hover:scale-105 cursor-pointer">
          <ResponsiveBar
            data={data}
